...
export default async function CartWaitingOrder(props: OrderProps) {
    ...
    return (
        <main className="mt-48 max-w-(--breakpoint-md) mx-auto">
            <div className="mt-10 ">
                <h1 className="font-bold text-3xl text-center text-balance">Thank you</h1>
                <p className="mt-4 text-center text-balance">
                    We&apos;re on it! Your order is beein created, and a confirmation email is on its way. Keep an eye
