...
export const Footer = () => {
    ...
    return (
        <footer className="mt-24  px-0 lg:px-12 2xl:px-0">
            <div className="max-w-(--breakpoint-2xl) mx-auto pt-24">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div>
                        <Link href="/" prefetch={true} className="h-7 block">
                            <svg viewBox="0 0 185 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
