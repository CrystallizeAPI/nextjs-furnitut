...
export const ParagraphCollection = ({ paragraphs }: ParagraphCollectionProps) => {
    return paragraphs?.map((paragraph, index) => (
        <div key={index} className="frntr-paragraph  w-auto py-3 first:pt-0">
            <div className="mx-auto">
                <h2 className="font-medium mt-4 mb-2 text-2xl ">{paragraph.title}</h2>
                <div
                    className={clsx(
                ...
                {paragraph.images?.length || paragraph.videos?.length ? (
                            ...
                            return (
                                <Image
                                    ...
                                    className={clsx(
                                        ...
                                        {
                                            'col-span-4!':
                                                index === 0 && paragraph.images && paragraph.images.length < 1,
                                        },
                                    )}
                                />
                            );
